...
export class Contract<T extends { [key: string]: Func }> {
  abi: ABI;
  code: CompiledCode;
  ...
  private members(address: Address, burrow: Burrow, handlers: Handlers): { [p: string]: Func } {
    return {
  ...
  private functions(address: Address, burrow: Burrow, handlers: Handlers): { [p: string]: Func } {

  }

  private events(address: Address, burrow: Burrow, handlers: Handlers): { [p: string]: Func } {
